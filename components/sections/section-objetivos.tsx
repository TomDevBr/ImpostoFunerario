...
export function SectionObjetivos({ className, ...props }: SectionObjetivosProps) {
  return (
    <section
      ...
      className={twMerge('w-full bg-[#0E1918] py-24 text-white', className)}
      {...props}
    >
      <div className="mx-auto max-w-[1157px] px-6">
        <SectionTitle>Objetivo da guild</SectionTitle>

        <p className="mt-12 text-[24px] leading-[1em] text-white text-center font-[var(--font-alegreya-sc)]">
        ...
        <div className="mt-12 grid gap-8 sm:grid-cols-2">
          <div>
            <h3 className="text-[24px] font-[var(--font-alegreya-sc)]">O que buscamos</h3>
          ...
          <div>
            <h3 className="text-[24px] font-[var(--font-alegreya-sc)]">Nossa filosofia</h3>
            <ul className="mt-4 space-y-2 text-[24px] font-[var(--font-alegreya-sc)]">
        ...
        <p className="mt-12 text-[24px] font-[var(--font-alegreya-sans)] text-white text-center">
